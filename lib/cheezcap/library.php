...
class Group {
	...
	public function __construct( $_name, $_id, $_options ) {
		$this->Group( $_name, $_id, $_options );
	}
...
class Option {
	...
	public function __construct( $_name, $_desc, $_id, $_std ) {
...
class MediaOption extends Option {
	...
	public function __construct( $_name, $_desc, $_id, $_std = ''  ) {
		$this->MediaOption( $_name, $_desc, $_id, $_std );
	}
...
class MultiOption extends Option {
	...
	public function __construct( $_name, $_desc, $_id, $_options, $_stdIndex = 0 ) {
		$this->MultiOption( $_name, $_desc, $_id, $_options, $_stdIndex );
	}
...
class TextOption extends Option {
	...
	public function __construct( $_name, $_desc, $_id, $_std = '', $_useTextArea = false ) {
		$this->Option( $_name, $_desc, $_id, $_std );
...
class BooleanOption extends DropdownOption {
	...
	public function __construct( $_name, $_desc, $_id, $_default = false ) {
		$this->BooleanOption( $_name, $_desc, $_id, $_default);
	}
...
function top_level_settings() {
	global $Fyda_themename;

	echo "<div class='sagey-cap'>";

	if ( isset( $_REQUEST['saved'] ) )
		echo '<div id="message" class="updated fade"><p><strong>' . \esc_html( $Fyda_themename . ' settings saved.' ) . '</strong></p></div>';
	if ( isset( $_REQUEST['reset'] ) )
		echo '<div id="message" class="updated fade"><p><strong>' . \esc_html( $Fyda_themename . ' settings reset.' ) . '</strong></p></div>';
	?>

	<div class="wrap">
		<h2><b><?php echo \esc_html( $Fyda_themename . " Settings" ); ?></b></h2>
